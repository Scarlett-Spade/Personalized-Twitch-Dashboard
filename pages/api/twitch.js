...
//--------------------------------------------------------
//This calls the custom API from React.JS, retreives the payload from the request, and returns the data back to Next.JS.--------------------------------------------------
...
//--------------------------------------------------------
//PROP ACTIONS: Tells variables which method to call.

//This gets Twitch access token --------------------------
...
//This gets the Twitch channel.-----------------------------
const getTwitchChannel = async channelName => {
  console.log('SEARCHING FOR TWITCH CHANNEL...')
  if (channelName) {
    //This is calling the method to get some sort of access token
    const accessToken = await getTwitchAccessToken()

    if (accessToken) {
      //This makes the request to Twitch API given some access token
